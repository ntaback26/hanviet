        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h3>Đây là một tool cho phép phiên âm văn bản chứa chữ Hán (phồn thể) về Hán - Việt.</h3>
                    
                    <h3>Nếu đây là lần đầu tiên bạn sử dụng tool này, vui lòng <a href="sync.php">Thêm dữ liệu vào cơ sở dữ liệu</a> để thực hiện các chức năng khác</h3>

                    <h3>Các công nghệ sử dụng trong dự án:</h3>
                    <h4>
                        <ul>
                            <li>PHP</li>
                            <li>MongoDB</li>
